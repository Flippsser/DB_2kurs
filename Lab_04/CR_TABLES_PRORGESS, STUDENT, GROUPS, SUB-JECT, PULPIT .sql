use UNIVER;
DROP TABLE PROGRESS, STUDENT, GROUPS, SUBJECT, TEACHER, PULPIT, PROFESSION, FACULTY, AUDITORIUM, AUDITORIUM_TYPE;

------------Создание и заполнение AUDITORIUM_TYPE
...
-------------Создание и заполнение AUDITORIUM
...
------Создание и заполнение FACULTY (добавлен ИДиП)
...
('ИДиП','Издательское дело и полиграфия');   -- добавлен

------Создание и заполнение PROFESSION
...
------Создание и заполнение PULPIT (добавлены недостающие кафедры)
create table PULPIT 
...
-- добавленные кафедры
('ИВД',    'Информационных систем и технологий?', 'ИТ'),   -- предположительно
('ПОиСОИ', 'Полиграфического оборудования и систем обработки информации', 'ТТЛП'),
('ОВ',     'Охотоведения?', 'ЛХФ'),
('ТНХСиППМ','Технологии неорганических химических систем и производства полимерных материалов', 'ХТиТ'),
('ХТЭПиМЭЕ','Химической технологии, электрохимии и материаловедения', 'ХТиТ');

------Создание и заполнение TEACHER
...
('ДТК',    'Дятко Александр Аркадьевич',    'м', 'ИВД'),
...
------Создание и заполнение SUBJECT (исправлены кафедры)
...
------Создание и заполнение GROUPS (убрана лишняя запятая)
create table GROUPS 
...
------Создание и заполнение STUDENT (varbinary(max))
...
------Создание и заполнение PROGRESS (дата исправлена)
